...
from prompt_utils import build_prompt_from_json, fill_chat_prompt
...
class RelationshipAgent:
    ...
    def generate_conversation_starter(self, config: dict = None) -> str:
        ...
        """
        conversation_starter_prompt = f"""/no_think
        You are {self.persona['first_name']} {self.persona['last_name']}, a {self.persona['personality']}.
